...
<div?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                for ($i = 1; $i <= 4; $i++) {
                                                    ...
                                                    if ($image) {
                                                        echo "<img src='uploads/$image' alt='Image' style='width: 100px; height: 100px; object-fit: cover; margin-right: 5px;'>";
                                                    }
                                                }
                                                ?>
                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-info"
                                                    ...
                                                    data-link="<?php echo $project['project_link']; ?>"
                                                    data-images='<?php echo json_encode([$project["image1"], $project["image2"], $project["image3"], $project["image4"]]); ?>'
            ...
            <div class="modal-content">
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="edit_project_images" class="d-flex mb-3"></div>
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        function editProject(button) {
            ...
            document.getElementById('edit_project_name').value = button.getAttribute('data-name');
            document.getElementById('edit_project_status').value = button.getAttribute('data-status');
            document.getElementById('edit_project_description').value = button.getAttribute('data-description');
            document.getElementById('edit_project_link').value = button.getAttribute('data-link');

            const images = JSON.parse(button.getAttribute('data-images'));
            const imageContainer = document.getElementById('edit_project_images');
            ...
            images.forEach(image => {
                if (image) {
                    ...
                    imgElement.style = 'width: 230px; height: 300px; object-fit: cover; margin-right: 5px; border: 1px solid #ddd; padding: 2px;';
